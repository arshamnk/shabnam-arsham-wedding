...
If you change the admin capabilities later, remember to republish the Firestore rules. The admin delete, donation-record, and website-based admin-grant features rely on the latest rules being live.
